...
(async()=>{
  ...
  { const OK=['pipe','stem','branch','pillar','stalac','icicle','dead','kelp','rock','spire','colon','nobori','yari'];
    ...
    const sg={};
    ['pillar','stalac','icicle','dead','kelp','rock','spire','colon','nobori','yari'].forEach(function(k){
