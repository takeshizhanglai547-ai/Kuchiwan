...
fail=0
for t in rpg feat watch feat2 ng2 sg wanden ng3 boss lvup evo foeatk fix myth grow steam anim anim2 bg crit train; do
...
echo "---"
[ $fail -eq 0 ] && echo "ALL 22 SUITES PASSED" || echo "SOME SUITES FAILED"
exit $fail
