...
(function (g) {
  ...
  ASH.vfx = function (T, scene) {
    ...
    function impactWorld(x, y, z) {
      ...
      size(0.30, 0.86, 0.24, 0.70);        // 気持ち横長。縦にレティクルへ伸ばさない
      E.rot = rnd() * 6.283;
      ...
      for (i = 0; i < 18; i++) {
        /* 芯を 0.34rad 抜く＝狙点の真上に粉塵を置かない。
           噴出は「面から円錐状に舞い上がる」ものなので、
           芯を抜いても現象としては嘘にならない。 */
        cone(0.92, 0.55, 0.34);
        o = rr(0.10, 0.50);
        sv = rr(2.4, 6.4);
