...
fail=0
for t in rpg feat watch feat2 ng2 sg wanden ng3 boss lvup evo foeatk fix grow steam anim anim2; do
...
echo "---"
[ $fail -eq 0 ] && echo "ALL 18 SUITES PASSED" || echo "SOME SUITES FAILED"
exit $fail
